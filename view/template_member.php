        ...
        <div class="container">
            ...
            <div class=" collapse navbar-collapse row menu menu_burger" id="navbarTogglerDemo03">
                <ul class="navbar-nav mt-2 mt-lg-0">
                    ...
                    <li class="nav-item active bar">
                        <a class="nav-link nav_linkR" href="index.php?action=member">Favorites</a>
                    </li>
                    <li class="nav-item active bar">
                        <a class="nav-link nav_linkR" href="index.php?action=connect/modifypassword">Account</a>
                    </li>
                    <li class="nav-item active bar">
                        <a class="nav-link nav_linkR" href="index.php?action=connect/logout">Logout</a>
                    </li>
                </ul>
            </div>
